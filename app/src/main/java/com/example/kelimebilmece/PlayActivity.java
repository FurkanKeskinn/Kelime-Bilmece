...
public class PlayActivity extends AppCompatActivity {
    ...
    private int cozulenKelimeSayısı = 0, cozulenSoruSayısı = 0, yapilanYanlisSayısı = 0, maksimumSorusayisi, maksimumKelimesayisi;
    ...
    public void btnIstatisticTablosu(View v) {
        maksimumVerileriHesepla("");
    }

    private void istatistikTablosunuGoster(String oyunDurumu, int maksimumSorusayisi, int maksimumKelimesayisi, int cozulenSoruSayısı, int cozulenKelimeSayısı, int yapilanYanlisSayısı) {
        ...
        statisticBarWordCount = (ProgressBar) statisticTableDialog.findViewById(R.id.custom_dialog_statistic_table_progressBarFalseGuessCount);
        ...
        statisticQuestionCount.setText(cozulenSoruSayısı + " / " + maksimumSorusayisi);
        statisticWordCount.setText(cozulenKelimeSayısı + " / " + maksimumKelimesayisi);
        statisticFalseGuessCount.setText(yapilanYanlisSayısı + " / " + maksimumKelimesayisi);

        statisticBarQuestionCount.setProgress(cozulenSoruSayısı);
        statisticBarWordCount.setProgress(cozulenKelimeSayısı);
        statisticBarWordCount.setProgress(yapilanYanlisSayısı);
    ...
    private void maksimumVerileriHesepla(String oyunDurumu) {
        ...
        try {
            ...
            istatistikTablosunuGoster(oyunDurumu, maksimumSorusayisi, maksimumKelimesayisi, cozulenSoruSayısı, cozulenKelimeSayısı, yapilanYanlisSayısı);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
            ...
            if (textTahminDegeri.matches(rastgeleKelime)) {
                ...
                if (kelimelerList.size() > 0) {
                    ...
                    if (sorularList.size() > 0) {
                        ...
                        maksimumVerileriHesepla("oyunBitti");
                    }
