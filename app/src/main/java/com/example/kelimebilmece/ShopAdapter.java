...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.ShopHolder> {
    ...
    class ShopHolder extends RecyclerView.ViewHolder {
        ...
        public ShopHolder(@NonNull View itemView) {
            ...
            txtItemTitle = (TextView) itemView.findViewById(R.id.custom_dialog_shop_textViewItemTitle);
            imgItem = (ImageView) itemView.findViewById(R.id.custom_dialog_shop_textViewItemImg);
            btnItemPrice = (Button) itemView.findViewById(R.id.custom_dialog_shop_btnItemPrice);
